...
add_filter( 'body_class', 'hoot_body_class_filter', 0, 2 );

/* Filters the WordPress 'post_class' early. */
add_filter( 'post_class', 'hoot_post_class_filter', 0, 3 );

/* Filters the WordPress 'comment_class' early. */
add_filter( 'comment_class', 'hoot_comment_class_filter', 0, 3 );
 ...
 * @return array
 */
function hoot_comment_class_filter( $classes, $class, $comment_id ) {
