...
function hoot_get_content_template() {
...
function hoot_get_header( $name = null ) {
...
function hoot_get_footer( $name = null ) {
...
function hoot_get_sidebar( $name = null, $context = '' ) {

	$get_template = apply_filters( 'hoot_get_sidebar_template', true, $context );
 ...
 * @return void
 */
function hoot_get_widget( $name = '' ) {
	include( hoot_locate_widget( $name ) );
}
 ...
 * @return void
 */
if ( !function_exists( 'hoot_locate_widget' ) ) :
function hoot_locate_widget( $name = '' ) {
	$templates = array();
