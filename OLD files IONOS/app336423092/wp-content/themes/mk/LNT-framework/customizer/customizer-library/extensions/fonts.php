...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'mk' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'mk' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'mk' ),
		'cyrillic'     => __( 'Cyrillic', 'mk' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'mk' ),
		'devanagari'   => __( 'Devanagari', 'mk' ),
		'greek'        => __( 'Greek', 'mk' ),
		'greek-ext'    => __( 'Greek Extended', 'mk' ),
		'khmer'        => __( 'Khmer', 'mk' ),
		'latin'        => __( 'Latin', 'mk' ),
		'latin-ext'    => __( 'Latin Extended', 'mk' ),
		'vietnamese'   => __( 'Vietnamese', 'mk' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'mk' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'mk' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'mk' ),
