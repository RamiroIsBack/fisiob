            ...
            AvisoLegalCookies(){
              return(
                <div>
                  ...
                  <p></p>
                  <p>
                  Las cookies son el medio técnico para la “trazabilidad” y seguimiento de la navegación en los Sitios Web. Son pequeños ficheros de texto que se escriben en el ordenador del Usuario. Este método tiene implicaciones sobre la privacidad, por lo que JAVIER BUENDIA CAPELLA informa de que podrá utilizar cookies con la finalidad de elaborar estadísticas de utilización del sitio web así como para identificar el PC del Usuario permitiendo reconocerle en sus próximas visitas. En todo caso, el usuario puede configurar su navegador para no permitir el uso de cookies en sus visitas al web site. JAVIER BUENDIA CAPELLA es consciente de la importancia de la protección de datos, así como de la privacidad de EL USUARIO y por ello, insiste en la lectura de la “Política de Cookies” de nuestra página web descrita a continuacion:</p>
                  <p>
                  Como usuario, puede rechazar el tratamiento de los datos o la información bloqueando estas cookies mediante la configuración de su navegador, pero si lo hace, la página no funcionará al 100%. Por eso es importante que lea esta política de cookies y comprenda que si continúa navegando, se considerará que acepta su uso. Puede cambiar la configuración de su navegador para que le avise de la recepción de cookies o desactivar la capacidad de almacenar dichas cookies en su disco duro. Las cookies NO suelen almacenar información sensible sobre usted como tarjetas de crédito o datos bancarios, fotografías o información personal, etc. Los datos que guardan son de carácter técnico, estadístico, preferencias personales, personalización de contenidos y similares. El servidor web no le asocia a usted como persona, sino a su navegador web.
                  </p>
                </div>)
              }
