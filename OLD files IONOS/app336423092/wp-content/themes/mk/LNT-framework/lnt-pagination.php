...
/*=========================================================
 ...
 =======================================================*/
	...
	function mk_round_num($num, $to_nearest) {
	   /*Round fractions down (http://php.net/manual/en/function.floor.php)*/
	   return floor($num/$to_nearest)*$to_nearest;
	}
	 
	/* Function that performs a Boxed Style Numbered Pagination (also called Page Navigation). */
	if (!function_exists('mk_pagenavi')) { 
		function mk_pagenavi($query, $before = '', $after = '') {
		    ...
		    $pagenavi_options['first_text'] = __('First Page', 'mk');
		    $pagenavi_options['last_text'] = __('Last Page', 'mk');
		    $pagenavi_options['next_text'] = __("Next", "mk");
		    $pagenavi_options['prev_text'] = __("Prev", "mk");
		    ...
		    if (!is_single()) {
		        ...
		        //mk_round_num() custom function - Rounds To The Nearest Value.
		        $larger_start_page_start = (mk_round_num($start_page, 10) + $larger_page_multiple) - $larger_per_page;
		        $larger_start_page_end = mk_round_num($start_page, 10) + $larger_page_multiple;
		        $larger_end_page_start = mk_round_num($end_page, 10) + $larger_page_multiple;
		        $larger_end_page_end = mk_round_num($end_page, 10) + ($larger_per_page);
		        ...
		        if($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
		            ...
		            $output .= $before.'<div class="pagination pagination-centered">'."\n";
