<div id="assistant-welcome-panel" class="dashboard-column dashboard-column4 welcome-panel assistant-dashboard-panel">
    <div class="dashboard-row">
        ...
        <div class="dashboard-column dashboard-column1 assistant-preview-text">
            <div class="inside">
                <h2>
	                <?php _ex( 'Configure your WordPress in just a few steps.', 'plugins-panel-second-run', 'uialfred-assistant' ); ?>
                </h2>
                <p class="about-description">
					<?php _ex( 'Get started and optimize your website with selected themes and plugins.', 'plugins-panel-second-run', 'uialfred-assistant' ); ?>
                </p>
                <?php if ( empty( $is_assistant_completed ) ): ?>
                    ...
                    <br>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=' . One_And_One_Assistant_Handler_Dispatch::ASSISTANT_PAGE_ID . '&sitetype=eshop' ) ); ?>"
