          ...
          <div id="secondary-menu">
            <?php 
              if (module_exists('i18n_menu')) {
                $secondary_menu_tree = i18n_menu_translated_tree(variable_get('menu_secondary_links_source', 'user-menu'));
              } else {
                $secondary_menu_tree = menu_tree(variable_get('menu_secondary_links_source', 'user-menu'));
              }
    ...
    <div class="container">
      <div class="row">
        <div class="fcred col-sm-12">
          <?php print t('Web realizada por'); ?>  <a href="http://www.awimbawe.com" target="_blank">Awimbawe</a>.
        </div>
      </div>
    </div>
  </div>
