...
add_action( 'save_post',         'mk_get_the_Image_delete_cache_by_post'        );
add_action( 'deleted_post_meta', 'mk_get_the_Image_delete_cache_by_meta', 10, 2 );
add_action( 'updated_post_meta', 'mk_get_the_Image_delete_cache_by_meta', 10, 2 );
add_action( 'added_post_meta',   'mk_get_the_Image_delete_cache_by_meta', 10, 2 );

/**
 * The main image function for displaying an image.  This is a wrapper for the Mk_Get_The_Image class. Use this 
 ...
 */
function mk_get_the_Image( $args = array() ) {

	$image = new Mk_Get_The_Image( $args );
 ...
 * what you're doing and expect your code to break in future versions.  Use the the `mk_get_the_Image()` 
 * wrapper function instead.  That's the reason it exists.
 *
 * @since  1.0.0
 * @access private
 */
final class Mk_Get_The_Image {
	...
	public function __construct( $args = array() ) {
		...
		add_filter( 'mk_get_the_Image_post_content', array( $wp_embed, 'run_shortcode' ) );
		add_filter( 'mk_get_the_Image_post_content', array( $wp_embed, 'autoembed'     ) );
	...
	public function get_image() {
		...
		$image_html = apply_filters( 'mk_get_the_Image', $this->image );
	...
	public function find() {
		...
		$image_cache = wp_cache_get( $this->args['post_id'], 'mk_get_the_Image' );
		...
		if ( !isset( $image_cache[ $key ] ) || empty( $cache ) ) {
			...
			if ( !empty( $this->image ) ) {
				...
				wp_cache_set( $this->args['post_id'], $image_cache, 'mk_get_the_Image' );
			}
		}
	...
	public function get_scan_image() {
		...
		$post_content = apply_filters( 'mk_get_the_Image_post_content', $post_content );
 ...
 * @return void
 */
function mk_get_the_Image_delete_cache_by_post( $post_id ) {
	wp_cache_delete( $post_id, 'mk_get_the_Image' );
}
 ...
 * @return void
 */
function mk_get_the_Image_delete_cache_by_meta( $meta_id, $post_id ) {
	wp_cache_delete( $post_id, 'mk_get_the_Image' );
}
 ...
 * @access     public
 */
function mk_get_the_Image_link() {
	_deprecated_function( __FUNCTION__, '0.3.0', 'mk_get_the_Image' );
	mk_get_the_Image( array( 'link_to_post' => true ) );
}
 ...
 * @access     private
 */
function mk_get_the_Image_delete_cache() {}
 ...
 * @access     private
 */
function mk_get_the_Image_by_meta_key() {}
 ...
 * @access     private
 */
function mk_get_the_Image_by_post_thumbnail() {}
 ...
 * @access     private
 */
function mk_get_the_Image_by_attachment() {}
 ...
 * @access     private
 */
function mk_get_the_Image_by_scan() {}
 ...
 * @access     private
 */
function mk_get_the_Image_by_default() {}
 ...
 * @access     private
 */
function mk_get_the_Image_format() {}
 ...
 * @access     private
 */
function mk_get_the_Image_meta_key_save() {}
